...
using MLApplicationsML.Model;

namespace MLApplicationsML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\SS\source\repos\GitHub ShawnShiSS\machine-learning-applications\src\MLNETModelBuilder\Datasets\SentimentAnalysisDataset.txt";
        private static string MODEL_FILEPATH = @"C:\Users\SS\AppData\Local\Temp\MLVSTools\MLApplicationsML\MLApplicationsML.Model\MLModel.zip";
